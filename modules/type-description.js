...
module.exports = function(typeid) {
    ...
    if (typeid === "2") {
        return "Home Rule Municipality";
    }
    if (typeid === "3") {
        return "Territorial Charter Municipality";
    }
    if (typeid === "4") {
        return "Statutory City";
    }
    if (typeid === "5") {
        return "Statutory Town";
    }
    if (typeid === "6") {
    ...
    if (typeid === "9") {
        return "Health Service District (Hospital)";
    }
    if (typeid === "10") {
    ...
    if (typeid === "70") {
        return "City & County Of Broomfield";
    }
    if (typeid === "71") {
    ...
    if (typeid === "95") {
        return "Board of Cooperative (Educational) Services (BOCES)";
    }
    if (typeid === "99") {
